...
// (apps/api/app/core/ordem_categories.json). Run `npm run sync:categories` after
...
const SRC = resolve(root, 'apps/api/app/core/ordem_categories.json')
...
const out = `// AUTO-GENERATED from apps/api/app/core/ordem_categories.json by \`npm run sync:categories\`.
