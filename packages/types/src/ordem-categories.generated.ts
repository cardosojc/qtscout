...
export const ORDEM_CATEGORIES = [
  ...
  { key: "PROGRESSO", label: "Sistema de Progresso", shape: "PROGRESSO_REF", scope: "SECTION" },
  { key: "NOITES_CAMPO", label: "Noites de Campo", shape: "NOITES_CAMPO_REF", scope: "SECTION" },
  { key: "ESPECIALIDADE", label: "Especialidades", shape: "ESPECIALIDADE_REF", scope: "SECTION" },
